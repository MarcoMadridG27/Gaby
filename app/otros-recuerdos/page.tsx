...
const otrosRecuerdos = [
    {
        ...
        about: {
            overview: 'Aunque no pudimos estar juntos en persona, hicimos de esa noche algo especial. Te envié flores, vimos algo y compartimos una cena a distancia. La proxima la pasaremos juntos en persona.',
        },
    }
